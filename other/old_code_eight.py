    ...
    try:
        ...
        for index, article in enumerate(product_articles):
            try:
                ...
                book_info['availability'] = 'out_of_stock' if availability_elem else "In stock"
                # Добавляем в список
...
arg_0 = get_page_preview(
    "https://www.ozon.ru/category/aksessuary-7697/?category_was_predicted=true&deny_category_prediction=true&from_global=true&text=шапки+мужские+зимние", page_type='category')
